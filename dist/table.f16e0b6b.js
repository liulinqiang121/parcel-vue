...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/components/table.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $ebf2db = exports.default || module.exports;
      
      if (typeof $ebf2db === 'function') {
        $ebf2db = $ebf2db.options;
      }
    
        /* template */
        Object.assign($ebf2db, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ebf2db', $ebf2db);
          } else {
            api.reload('$ebf2db', $ebf2db);
          }
        }
...
//# sourceMappingURL=/table.f16e0b6b.map